...
class IkarGame:
    ...
    def secret_room_story(self):
        ...
        self.print_slow("поэтому в общаге есть 'та самая' комната, где творится магия.")
    ...
    def tea_party_story(self):
        ...
        self.print_slow("например, весь второй этаж знает про их успокоительный чай,")
    ...
    def invite_alexander(self):
        ...
        if battle_result:
            ...
            self.print_slow(f"Трепещите тараканы, {player.username} покажет вам, где раки зимуют!!!")
            print("=" * 60)
            input("\nНажми Enter чтобы продолжить...")
    ...
    def room_2209_story(self):
        ...
        print("\nТвои действия:")
        print("1. Зайти и поздороваться с Ольгой Васильевной")
        print("2. Пройти мимо")
        print("=" * 60)
